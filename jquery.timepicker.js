...
(function (factory) {
	...
	//Credit: https://github.com/mholt/PapaParse/blob/master/papaparse.js#L35
	var global = (function() {
			...
			show: function(e)
			{
				...
				if(settings.stopScrollPropagation) {
					$(document).on('wheel.ui-timepicker', '.ui-timepicker-wrapper', function(e){
						// This is probably the fix: https://github.com/jquery/jquery/issues/2871#issuecomment-497963776
						// e.preventDefault();
